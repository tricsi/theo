let ctx = $("#game").getContext("2d"),
    ...
    game = new Game(draw, [
        ...
        "M0,0,10,10,8,2,1,6,7,8,6,7,5,8,1,9,7,10,0|H8,9|D6,9,5,6|C8,8|C9,7|C8,6|C9,5|C8,4|C9,3|C8,2|C9,1|E6,7|#Pfff...",
        ...
        "M0,0,10,5,8,10,7,7,6,9,4,6,6,3,8,1,1,10,0|H4,0|D4,8,0,9|C8,1,9,1|C6,4,7,4|#Pfff...",
        "M0,0,10,10,0|M1,2,4,3,1|M6,2,9,3,6|M1,4,2,6,1|M3,4,7,6,3|M8,4,9,6,8|M1,7,3,8,7,7,9,8,8,9,2,8,1|H2,1|D7,1,5,9|E2,3|E7,3|#:)",
        "M0,0,10,10,0|M1,3,2,2,3,1,7,2,8,3,9,7,8,8,7,9,6,7,7,6,8,4,7,3,6,2,4,3,3,4,2,6,3,7,4,9,3,8,2,7,1|M4,4,6,6,4|H4,0|D5,0,4,3|C2,1,0,1|C7,1,9,1|C1,7,1,9|C8,7,8,9|#Oh no...|#Moving cogs!",
        "M0,0,10,10,0|M2,2,4,6,6,2,8,8,2|H4,9,1|D2,9,3.8,5|B6,9|#Oh no, monsters!",
        "M0,0,10,10,0|M1,1,9,5,8,2,5,3,7,7,3,5,4,6,6,4,3,3,4,2,2,8,8,6,9,9,1|M6,0,7,1,6|M7,6,8,7,7|H4,0|D5,5,7,0|G26,19|#The road is blocked!",
        "M0,0,1,2,4,6,5,1,2,0,6,4,7,2,9,1,7,0,10,3,8,4,10,7,8,9,9,8,10,10,7,6,9,5,6,10,0,7,3,3,1,4,2,6,1,5,0|M1,8,4,7,5,9,1|H8,9|D7,0,1,5|#This is a labyrinth.",
